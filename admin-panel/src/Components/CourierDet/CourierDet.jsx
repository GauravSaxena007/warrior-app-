...
const CourierDet = () => {
  ...
  const fetchCouriers = async () => {
    try {
      const res = await axios.get(`${import.meta.env.VITE_API_URL}/courier`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(`${import.meta.env.VITE_API_URL}/courier`, form);
  ...
  const handleDelete = async (id) => {
    try {
      const res = await axios.delete(`${import.meta.env.VITE_API_URL}/courier/${id}`);
